...
def My_NMS(boxes, scores, iou_thres, GIoU=False, DIoU=True, CIoU=False):
    """
...
def bbox_iou(box1, box2, x1y1x2y2=False, GIoU=False, DIoU=True, CIoU=False, alpha=3, eps=1e-9):
...
def non_max_suppression(prediction, conf_thres=0.25, iou_thres=0.45, classes=None, agnostic=False, multi_label=False,
    ...
    for xi, x in enumerate(prediction):  # image index, image inference
        ...
        i = My_NMS(boxes, scores, iou_thres, GIoU=False, DIoU=True, CIoU=False)  # 更改后的NMS
